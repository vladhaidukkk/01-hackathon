...
export class StartScreen {
    ...
    show() {
        ...
        container.className = 'container-main w-full h-full flex justify-center items-center flex-col transition-all';
        ...
        startBtn.className =
            'bg-white px-20 py-2 text-gray-700 text-lg rounded tracking-wider hover:scale-105 transform transition-all';
